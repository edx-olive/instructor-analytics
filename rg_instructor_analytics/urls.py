...
from rg_instructor_analytics.views.gradebook import DiscussionActivityView, GradebookView, StudentStepView, VideoView
from rg_instructor_analytics.views.insights import (
    CsvReportInitializerView,
    InsightsStatisticView,
    list_instructor_tasks,
    list_report_downloads,
)
from rg_instructor_analytics.views.problem import (
    ProblemDetailView,
    ProblemHomeWorkStatisticView,
    ProblemQuestionView,
    ProblemsStatisticView,
    ProblemStudentDataView,
)
...
urlpatterns = [
    ...
    url(r'^api/problem_statics/problem_student_data/$', ProblemStudentDataView.as_view(), name='problem_student_data'),
    # Gradebook tab:
    ...
    url(r'^api/insights/generate_report/$', CsvReportInitializerView.as_view(), name='insights_report'),
    url(
        r'^api/(?P<tasks_type>[^/]+)/list_instructor_tasks/$',
        list_instructor_tasks,
        name='list_instructor_analytics_tasks',
    ),
    url(r'^api/(?P<report_type>[^/]+)/list_report_downloads/$', list_report_downloads, name='list_report_downloads'),
